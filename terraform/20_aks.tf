...
#   vnet_subnet_id        = module.aks_subnets.aks_node_subnet_ids["aks_user_pool_1"]    # var.aks_config.node_pool_map.node_pool_name ???
#   pod_subnet_id         = module.aks_subnets.aks_pod_subnet_ids["aks_user_pool_2"]     # var.aks_config.node_pool_map.node_pool_name ???
