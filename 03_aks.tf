...
module "aks_cluster" {
  ...
  subnet_ids                      = local.subnet_ids
                # module.main.subnet_ids
                # azurerm_subnet.aks_subnets
  #log_analytics_workspace_id = azurerm_log_analytics_workspace.workspace.id
  aks_config  = var.aks_config
  # aks_config  = {
  #   aks_log_analytics_workspace_id      = azurerm_user_assigned_identity.aks_cluster_identity.id
  #                                         #var.aks_log_analytics_workspace_id
  # }
  depends_on = [
    azurerm_subnet.aks_subnets
  ]
