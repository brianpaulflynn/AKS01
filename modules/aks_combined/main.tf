...
module "aks_nsrs" {
  ...
  node_subnet_prefixes        = flatten(values(module.aks_subnets.aks_node_address_prefixes))
  pod_subnet_prefixes         = flatten(values(module.aks_subnets.aks_pod_address_prefixes))
}
# AKS Cluster
